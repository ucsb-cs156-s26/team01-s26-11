...
* Prod: <https://team01.dokku-11.cs.ucsb.edu>
* QA: <https://team01-qa.dokku-11.cs.ucsb.edu>

TODO: Fill in this table with correct information. 

| Table                     | Name         | Github Id     |
|---------------------------|--------------|---------------|
| UCSBDiningCommonsMenuItem | Nini         | yensydney     |
| UCSBOrganization          | Rushabh      | RushabhTaneja |
| RecommendationRequest     | Minh         | itbolt        |
| MenuItemReview            | Anish        | anishjai56    |
| HelpRequest               | Brian        | Hudinid       |
| Articles                  | Wilson       | adovkoder     |
